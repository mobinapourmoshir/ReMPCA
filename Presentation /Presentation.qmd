...
- \hyperlink{algo:CvSparse}{Algorithm: CV Tuning for Sparsity} and equation \eqref{eq:MGCV one-way} are used to tune the sparsity level via K‐fold cross‐validation (CV) and the smoothing parameter via generalized cross‐validation (GCV), respectively.
:::
