...
- The block-diagonal penalty matrix is  $\pmb{\Omega} = \operatorname{diag}\bigl(\Omega_1, \Omega_2, \dots, \Omega_p\bigr),$
...
\begin{enumerate}[<+->]
  ...
  \item {Iterate until convergence:}
    \begin{enumerate}
      ...
      \item {Update right singular vector:} $v \leftarrow \pmb{h_\gamma}\,\pmb{X}^\top u$
