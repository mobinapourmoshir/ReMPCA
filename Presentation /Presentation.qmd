...
- *All grid points contribute equally → no feature selection.*   
  **Sparsity** acts as an inherent feature selector, focusing attention on key time points or locations.
- Sparse FPCA formulation [@huang2008sparse]:  
    ...
    \vspace{-1.5em}
    \begin{flushleft}
    \qquad \quad where $p_\gamma(v)$ is a sparsity-inducing penalty. 
    \end{flushleft}
    ```
