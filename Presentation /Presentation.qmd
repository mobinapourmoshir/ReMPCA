...
- Data matrix $\pmb{X}$: seek $u, v$ solving:
  ...
  $$
- Penalties: smoothness, sparsity (soft/hard thresholding, SCAD, group lasso).  
- Iterative updates:  
  - $u \leftarrow \pmb S_u^{[\alpha_u]} \; \pmb h_u^{[\gamma_u]}(\pmb X v)$  
  - $v \leftarrow \pmb S_v^{[\alpha_v]} \; \pmb h_v^{[\gamma_v]}(\pmb X^\top u)$ 
  - Normalize $v$.  
