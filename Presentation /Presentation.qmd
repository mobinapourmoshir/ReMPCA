...
\uncover<1->{\includegraphics[width=.8\textwidth]{images/True.pdf}}
\end{subfigure}
\begin{subfigure}[b]{0.24\textwidth}\centering
\uncover<2->{\includegraphics[width=.8\textwidth]{images/svd_Reconstructed.pdf}}
\end{subfigure}
\begin{subfigure}[b]{0.24\textwidth}\centering
\uncover<3->{\includegraphics[width=.8\textwidth]{images/Lasso_reconstructed.pdf}}
\end{subfigure}
\begin{subfigure}[b]{0.24\textwidth}\centering
\uncover<4->{\includegraphics[width=.8\textwidth]{images/u1plots.pdf}}
\end{subfigure}

\begin{subfigure}[b]{0.24\textwidth}\centering
\uncover<5->{\includegraphics[width=.8\textwidth]{images/NoisyChessboard.pdf}}
\end{subfigure}
\begin{subfigure}[b]{0.24\textwidth}\centering
\uncover<6->{\includegraphics[width=.8\textwidth]{images/smooth_reconstructed.pdf}}
\end{subfigure}
\begin{subfigure}[b]{0.24\textwidth}\centering
\uncover<7->{\includegraphics[width=.8\textwidth]{images/pic.compress.pdf}}
\end{subfigure}
\begin{subfigure}[b]{0.24\textwidth}\centering
\uncover<8->{\includegraphics[width=.8\textwidth]{images/v1plots.pdf}}
\end{subfigure}
\end{figure}
```
...
\centering
\begin{minipage}[t]{0.32\textwidth}\centering
  \includegraphics[width=\textwidth]{\detokenize{images/Simulation 2 - Two-Way_Smoothness.pdf}}\\
\end{minipage}\hfill
\begin{minipage}[t]{0.32\textwidth}\centering
  \includegraphics[width=\textwidth]{\detokenize{images/Simulation 2 - Two-Way_Sparsity.pdf}}\\
\end{minipage}\hfill
\begin{minipage}[t]{0.32\textwidth}\centering
  \includegraphics[width=\textwidth]{\detokenize{images/Simulation 2 - Two-way_Sparsity_and_Smoothness.pdf}}\\
\end{minipage}
```
...
::: columns
::: {.column width="100%"}
![](images/Motion Sense PCS.pdf){width="92%" fig-align="center"}
:::
:::
