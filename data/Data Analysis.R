...
# #                 Sparsity_parameter = 0)
# #
# # w1 <- 1 / mean(apply(X1obj, 2, var))
# # w2 <- 1 / mean(apply(X2obj, 2, var))
# #
...
# #                            sparse_tuning_v = NULL,
# #                            smooth_tuning_u = NULL,
# #                            smooth_tuning_v = list(3.027727e-06,
# #                                                   4.485274e-05))
# #
...
# #
# # par(mfrow = c(2,3))
# # matplot(Motion_SVD_v11, type = 'l', main = 'v11', lwd=2)
# # points(Motion_SmV_v11, type = 'l', col = 'red', lwd=2)
# # matplot(Motion_SVD_v12, type = 'l', main = 'v12', lwd=2)
# # points(Motion_SmV_v12, type = 'l', col = 'red', lwd=2)
# # matplot(Motion_SVD_v21, type = 'l', main = 'v21', lwd=2)
# # points(Motion_SmV_v21, type = 'l', col = 'red', lwd=2)
# # matplot(Motion_SVD_v22, type = 'l', main = 'v22', lwd=2)
# # points(Motion_SmV_v22, type = 'l', col = 'red', lwd=2)
# # matplot(Motion_SVD_v31, type = 'l', main = 'v31', lwd=2)
# # points(Motion_SmV_v31, type = 'l', col = 'red', lwd=2)
# # matplot(Motion_SVD_v32, type = 'l', main = 'v32', lwd=2)
# # points(Motion_SmV_v32, type = 'l', col = 'red', lwd=2)
# #
#
#
#
...
# X1obj <- fdClass(as.matrix(motion_sense_data$user_acceleration),
#                  Smoothing_parameter = 0,
#                  Sparsity_parameter =c(4,45,91,95)) #round(seq(0,95, length.out = round(96/4, digits = 0)), digits = 0))
#
# X2obj <- fdClass(as.matrix(motion_sense_data$pitch_attitude),
#                  Smoothing_parameter = 0,
#                  Sparsity_parameter =c(4,45,91,95)) #round(seq(0,95, length.out = round(96/4, digits = 0)), digits = 0))
...
#                 Smoothing_parameter = 0,
#                 Sparsity_parameter = c(0,85,90,110))
#
