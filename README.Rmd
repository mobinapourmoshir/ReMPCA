...
data_sin <- function(){
  set.seed(123)
  t1 <- "p"; t2 <- "l"; n <- 20; m <- 100; sig <- 0.01; alpha1 <- 1; alpha2 <- 0
...
par(mfrow = c(1,2))
# Var 1
matplot(t(mvfd_obj[[1]]), type = 'l', main = "Noisy data", ylab = "Variable #1 - Data")
matplot(t(sim_results_sin$Estimated[[1]][,1:100]), type = 'l', main = "SSMFPC result", ylab = "Variable #1 - Estimates")

# Var 2
matplot(t(mvfd_obj[[2]]), type = 'l', main = "Noisy data", ylab = "Variable #2 - Data")
matplot(t(sim_results_sin$Estimated[[1]][,101:200]), type = 'l', main = "SSMFPC result", ylab = "Variable #2 - Estimates")
```
