...
# 
#       GCV[i] <- (1 / m) * norm_vec(Xu_proj - v)^2 / denom
#     }
# 
...
GCV_result_v = opt_alpha_v(X = X_temp,
                           ...
                           S_alphas_v = S_alpha_list_v, # A list (length = n_var)
                           S_alphas_u = diag(nrow(X_temp)),
                           alphas_v = setNames(data.frame(unique(smooth_tuning_col[,1]) ,
...
Now, let's see the results on the data:
...
Having both variables to be functional, we'll get:
