...
v2 <- sin(x2) + rnorm(length(x2), sd = 0.2)
...
fd_object2 <- fdClass(data = as.matrix(X2),
                     ...
                     Sparsity_parameter = round(seq(1,39, length.out = 20)))
...
fd_object3 <- fdClass(data = as.matrix(X3),
                     argval = NULL, 
                     Smoothing_parameter = 10^seq(-8, 3, length.out = 20),  
...
plot(CV_results[[2]]$gamma, CV_results[[2]]$cv_means, type = 'b', pch = 19)
abline(h = min(CV_results[[2]]$cv_means) + CV_results[[2]]$cv_ses[which.min(CV_results[[2]]$cv_means)],
       col = 'red', lty = 2)
points(gamma_v[1], CV_results[[2]]$cv_means[which(CV_results[[2]]$gamma == gamma_v[2])],
       col = 'blue', pch = 19)

```

```{r}
plot(CV_results[[2]]$gamma_Xi, CV_results[[2]]$cv_means, type = 'l', log='x')
```
